...
const WebPreview = lazy(() =>
  import('./ai-elements/web-preview').then((mod) => ({
...
export default function ProjectsPage() {
  ...
  const projectNames = useMemo(() => hardcodedProjects.map((p) => p.name), [])
  ...
  return (
    ...
    >
      ...
      <main className="flex-1 relative z-10 ">
        ...
        <div className="relative grid grid-cols-6 grid-rows-7 md:grid-cols-8 md:grid-rows-5 lg:grid-rows-6 gap-3 m-4 md:m-6 lg:m-10 h-[calc(100vh-6rem)] md:h-[calc(100vh-9rem)] lg:h-[calc(100vh-5rem)]">
          {/* Web Preview - Mobile: 5x4, Tablet: 6x4, Desktop: 6x5 */}
          <div className="col-span-6 row-span-4 md:col-span-6 md:row-span-5 lg:row-span-5 lgrounded-2xl md:rounded-3xl overflow-hidden bg-black/80 backdrop-blur-sm border-2 border-purple-500/20 relative">
          ...
          {/* Project List / Description - Mobile: 5x2, Tablet: 2x5, Desktop: 2x6 */}
          <div className="col-span-6 row-span-2 row-start-5 md:col-span-2 md:row-span-4 md:col-start-7 md:row-start-1 lg:col-span-2 lg:row-span-5 lg:col-start-7 lg:row-start-1 rounded-2xl md:rounded-3xl overflow-hidden bg-black/80 backdrop-blur-sm border-2 border-purple-500/20">
          ...
          {/* Featured Projects - Hidden on mobile, shown on desktop: 3x 2x1 thumbnails below main preview */}
          {featuredProjects.map((project, index) => (
            <div
              key={project.id}
              className="hidden lg:block col-span-2 row-span-1 row-start-6"
          ...
          <div className="col-span-3 row-span-1 row-start-7  md:col-span-1 md:row-span-1 md:col-start-7 md:row-start-5 lg:col-span-1 lg:row-span-1 lg:col-start-7 lg:row-start-6">
            <button
          ...
          <div className="col-span-3 row-span-1 row-start-7 col-start-4 md:col-span-1 md:row-span-1 md:col-start-8 md:row-start-5 lg:col-span-1 lg:row-span-1 lg:col-start-8 lg:row-start-6">
            <button
