    ...
    <div className={`relative w-full ${className}`}>
      ...
      >
        {items.map((item, index) => (
          ...
          >
            <div
              className={`p-4 bg-black/60 backdrop-blur-sm border border-purple-500/20 rounded-lg transition-all duration-200 ${selectedIndex === index ? 'bg-purple-600/20 border-purple-500/50 scale-[1.02]' : 'hover:bg-black/80'} ${itemClassName}`}
            >
